...
class Population {
	...
	evolve(callback) {
		...
		warn(this.species.length > 10, "There are too many species.");
		...
		warn(!bestSpecies, "Couldn't find best species.");
		...
		warn(this.species.length == 0, "Reusing previous population.")
